...
export const firmState: FirmState = {
  ...
  agentRoster: {
    total: 50,
    personaShells: 250,
    note: '50 Paperclip seed rows + 250 OpenClaw persona shells (5 files × 50 agents) landed at CP3. 17 agents flagged for tier-remap in PROVIDER-AUTH-MATRIX.',
    departments: [
      { name: 'C-Suite', count: 9 },
      { name: 'Engineering', count: 9 },
      { name: 'Research', count: 9 },
      { name: 'Trading Desk', count: 8 },
      { name: 'Risk & Performance', count: 4 },
      { name: 'Ops + R&D', count: 6 },
      { name: 'Audit', count: 5 },
    ],
    tierDistribution: [
      { tier: 'opus', count: 8 },
