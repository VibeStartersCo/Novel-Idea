...
import { Menu, X, ChevronRight, FileText, Calendar, Clock, User, CheckCircle, ShieldAlert, BrainCircuit, Target } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-6">
          ...
          <div>
            ...
            <nav className="space-y-1">
              <button
                onClick={() => { setCurrentView('mission'); if (window.innerWidth < 768) setIsSidebarOpen(false); }}
              ...
              >
                <Target size={16} className={currentView === 'mission' ? 'text-[#F27D26]' : 'text-gray-500'} />
                <span>Mission Control</span>
              </button>
              <div className="px-3 pt-4 pb-1">
                <div className="text-[10px] font-mono text-gray-600 uppercase tracking-widest">Concept archive</div>
                <div className="text-[10px] text-gray-600 leading-snug mt-0.5">original vision — held for reactivation</div>
              </div>
              <button
              ...
              >
                ...
                <span>Strategy Document <span className="text-[10px] text-gray-600 font-mono">(concept)</span></span>
              </button>
              <button
              ...
              >
                ...
                <span>Risk Dashboard <span className="text-[10px] text-gray-600 font-mono">(concept)</span></span>
              </button>
              <button
              ...
              >
                ...
                <span>Agent Training <span className="text-[10px] text-gray-600 font-mono">(concept)</span></span>
              </button>
            </nav>
          </div>
